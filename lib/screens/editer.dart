          ...
          Padding(padding: EdgeInsets.only(right: 20.0),
            child:GestureDetector(
              onTap: ()async {
                ...
                }).catchError((error) => print("Failed to update Node due to $error"));
              } ,
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(widget.doc['creation_date'],style: Appstyle.dataTitle,),
    ...
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          if(paths!="") SizedBox(width: 69.0,),
          if(paths!="") FloatingActionButton.extended(
              label: Text("replace"),
              onPressed: ()async{
