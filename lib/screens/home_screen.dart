        ...
        child: Column(
         mainAxisAlignment: MainAxisAlignment.start,
          ...
          children: [
            ...
            Expanded(
              child: StreamBuilder<QuerySnapshot>(stream: FirebaseFirestore.instance.collection("Notes").snapshots(),
              builder: (context,AsyncSnapshot<QuerySnapshot> snapshot){
                ...
                return Text("No Notes present", style: GoogleFonts.nunito(color:Colors.white ),);
              },
              ),
            )
          ],
